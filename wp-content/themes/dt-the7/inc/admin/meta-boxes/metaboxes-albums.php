...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'background under masonry post', array(
			'name'				=> _x( 'Background under album:', 'backend metabox', LANGUAGE_ZONE ),
		...
		// Show excerpts
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_exerpts", 'name' => _x( 'Show albums excerpts:', 'backend metabox', LANGUAGE_ZONE ) ) ),
		...
		// Show categories
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_categories_in_post_meta", 'name' => _x( 'Show album categories:', 'backend metabox', LANGUAGE_ZONE ) ) ),

		// Show date
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_date_in_post_meta", 'name' => _x( 'Show album date:', 'backend metabox', LANGUAGE_ZONE ) ) ),

		// Show author
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_author_in_post_meta", 'name' => _x( 'Show album author:', 'backend metabox', LANGUAGE_ZONE ) ) ),

		// Show comments
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_comments_in_post_meta", 'name' => _x( 'Show album comments:', 'backend metabox', LANGUAGE_ZONE ) ) ),

		// Show media numbers
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_numbers_in_post_meta", 'name' => _x( 'Show number of images &amp; videos:', 'backend metabox', LANGUAGE_ZONE ) ) ),
...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		// Show excerpts
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_exerpts", 'name' => _x( 'Show items captions:', 'backend metabox', LANGUAGE_ZONE ) ) ),
...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		array(
			'name'     		=> _x('Open album:', 'backend metabox', LANGUAGE_ZONE),
			'id'       		=> "{$prefix}open_album",
			'type'     		=> 'radio',
			'std'			=> 'lightbox',
			'options'  		=> array(
				'lightbox' => _x( 'Lightbox', 'backend metabox', LANGUAGE_ZONE ),
				'post' => _x( 'Album page', 'backend metabox', LANGUAGE_ZONE )
			),
			'bottom_divider'	=> true
		),
		...
		array(
			...
			'options'	=> array(
				...
				'photo_scroller' 	=> array( _x('PhotoScroller', 'backend metabox', LANGUAGE_ZONE), array('photoscroller.gif', 75, 50) )
			),
			'hide_fields'		=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'opacity slider', array(
			'name'		=> _x( 'Inactive image opacity (%):', 'backend metabox', LANGUAGE_ZONE ),
